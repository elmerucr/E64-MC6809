 ...
 *
 *
 * Update 2022-03-25, added as public member function in video_t class
 *
 */
...
public:
	...
	void alpha_blend(uint16_t *destination, uint16_t *source)
	{
	...
	inline bool is_using_scanlines() { return using_scanlines; }
