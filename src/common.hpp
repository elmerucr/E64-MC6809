 ...
 * E64
 *
 * Copyright © 2017-2022 elmerucr. All rights reserved.
 *
...
#define E64_BUILD            20220930
#define E64_YEAR             2022

/*
 * Video related
 */
#define PIXELS_PER_SCANLINE	512
#define SCANLINES		288
#define TOTAL_PIXELS		(PIXELS_PER_SCANLINE*SCANLINES)
#define FPS			60

/*
 * Clock rates
 */
#define CPU_CLOCK_SPEED		4800000			// note: lower than this causes delays in text mode kernel at 64x32 chars
#define CPU_CYCLES_PER_FRAME	(CPU_CLOCK_SPEED/FPS)
#define BLIT_CLOCK_SPEED	48000000
#define BLIT_CYCLES_PER_FRAME	(BLIT_CLOCK_SPEED/FPS)
